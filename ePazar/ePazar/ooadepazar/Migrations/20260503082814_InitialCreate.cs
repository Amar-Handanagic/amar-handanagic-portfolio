        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    KurirskaSluzba = table.Column<string>(type: "TEXT", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Lokacija = table.Column<string>(type: "TEXT", maxLength: 20, nullable: false),
                    DatumObjave = table.Column<DateTime>(type: "TEXT", nullable: false),
                    DatumAzuriranja = table.Column<DateTime>(type: "TEXT", nullable: false),
                    Narucen = table.Column<bool>(type: "INTEGER", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    KorisnikIdId = table.Column<string>(type: "TEXT", nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ID = table.Column<int>(type: "INTEGER", nullable: false)
                        .Annotation("Sqlite:Autoincrement", true),
                    PraceniIDId = table.Column<string>(type: "TEXT", nullable: true),
                    PratilacIDId = table.Column<string>(type: "TEXT", nullable: true)
                },
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        column: x => x.PraceniIDId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_Pracenje_AspNetUsers_PratilacIDId",
                        column: x => x.PratilacIDId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id");
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ID = table.Column<int>(type: "INTEGER", nullable: false)
                        .Annotation("Sqlite:Autoincrement", true),
                    DatumNarudzbe = table.Column<DateTime>(type: "TEXT", nullable: false),
                    DatumObrade = table.Column<DateTime>(type: "TEXT", nullable: true),
                    Status = table.Column<int>(type: "INTEGER", nullable: false),
                    Lokacija = table.Column<string>(type: "TEXT", nullable: false),
                    KorisnikId = table.Column<string>(type: "TEXT", nullable: true),
                    ArtikalID = table.Column<int>(type: "INTEGER", nullable: true),
                    KurirskaSluzbaId = table.Column<string>(type: "TEXT", nullable: true)
                },
                constraints: table =>
                {
